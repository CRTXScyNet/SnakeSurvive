...
public class Apple {
    ...
    Apple(BufferedImage image){
        xy = new int[]{(int)(Math.random()*image.getWidth()*playGround[0])+(int)(image.getWidth()*playGround[1]),(int)(Math.random()*image.getHeight()*playGround[0])+(int)(image.getHeight()*playGround[1])};
    }
